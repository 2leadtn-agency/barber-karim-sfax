const CHATBOT_CONFIG = {
  ...
  systemPrompt:
    "Vous êtes l'assistant virtuel de Barber Karim, salon de coiffure homme à Sfax. Répondez de façon chaleureuse et professionnelle aux questions sur les prestations (coupe, taille de barbe, soin du visage), les disponibilités et les informations pratiques du salon.",
  businessName: "Barber Karim",
  whatsappNumber: "21653535535",
  primaryColor: "#C89B3C",
...
;(function () {
  ...
  const WELCOME_MESSAGE =
    "👋 Bonjour ! Bienvenue chez Barber Karim. Une question sur nos prestations ou nos disponibilités ? Je suis là pour vous aider"
